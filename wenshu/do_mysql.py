...
def insert_content_data(item, doc_type):
    if "s1" in item:
        ...
        cursor.execute(
            "INSERT INTO t_content(type, `s1`,`s2`,`s3`,`s5`,`s6`,`s7`,`s8`,`s9`,`s10`,`s31`,`s41`,`s43`,`s22`,`s23`,`s25`,`s26`,`s27`,`s28`,`s17`,`s45`,`s11`,`relWenshu`,`qwContent`,`directory`,`globalNet`,`s47`,`viewCount`,`wenshuAy`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            data_tuple,
        )
...
# 固定偏移量（IV，必须是 8 字节）
iv = b"20250331"  # 如果不足 8 字节，可以填充或截断
type_value = 3
