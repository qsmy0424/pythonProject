...
def login(username, password):
    ...
    url = ""
    urlToken = ("https://m.cloud.189.cn/udb/udb_login.jsp?pageId=1&pageKey=default&clientType=wap&redirectURL=https"
                "://m.cloud.189.cn/zhuanti/2021/shakeLottery/index.html")
    s = requests.Session()
    r = s.get(urlToken)
...
def lambda_handler():  # aws default
    main()


def main_handler():  # tencent default
    main()


def handler():  # aliyun default
    main()
